...
def prepare_parser():
  ...
  parser.add_argument(
      '--square_size', type=int, default=32,
      help='')
  parser.add_argument(
...
dset_dict = {'I32': dset.ImageFolder, 'I64': dset.ImageFolder,
            ...
            'MNIST':dset.MNIST, 'square':synth_dataset.get_dataset
}
...
nchannels_dict = {'I32': 3, 'I32_hdf5': 3,
               'I64': 3, 'I64_hdf5': 3,
               'TI64': 3, 'TI64_hdf5': 3,
               'I128': 3, 'I128_hdf5': 3,
               'I256': 3, 'I256_hdf5': 3,
               'C10': 3, 'C100': 3, 'STL64': 3, 'STL32': 3, 'STL48': 3, 'STL96': 3,'MNIST':1,
               'square':1
}
...
def get_data_loaders(dataset, data_root=None, augment=False, batch_size=64, 
                     ...
                     use_test_set=False, square_size = 32,
                     **kwargs):
  ...
  if dataset in ['square']:
      image_size = square_size
      dataset_kwargs['square_size'] = square_size
