...
class MNIST(dset.MNIST):
  def __init__(self, root, train=True,
    ...
    self.labels += targets.numpy().tolist()
    ...
    if self.train=='validate':    
      ...
      self.data = self.data.reshape((int(60e3 * self.val_split), 1, 28, 28))
      self.data = np.pad(self.data,((0,0),(0,0),(2,2),(2,2)))
      self.data = np.pad(self.data,((0,0),(1,1),(0,0),(0,0)), mode = 'edge')
      self.data = self.data.transpose((0, 2, 3, 1))  # convert to HWC
      ...
      self.data = self.data.reshape((int(60e3 * (1.-self.val_split)), 1, 28, 28))
      self.data = np.pad(self.data,((0,0),(0,0),(2,2),(2,2)))
      self.data = np.pad(self.data,((0,0),(1,1),(0,0),(0,0)), mode = 'edge')
      self.data = self.data.transpose((0, 2, 3, 1))  # convert to HWC
    else:
      ...
      self.labels = targets
      self.labels = entry['fine_labels']
      self.data = self.data.reshape((10000, 1, 28, 28))
      self.data = np.pad(self.data,((0,0),(0,0),(2,2),(2,2)))
      self.data = np.pad(self.data,((0,0),(1,1),(0,0),(0,0)), mode = 'edge')
      self.data = self.data.transpose((0, 2, 3, 1))  # convert to HWC
